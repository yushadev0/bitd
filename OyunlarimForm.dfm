object OYUNLARIM_FORM: TOYUNLARIM_FORM
  Left = 0
  Top = 0
  ClientHeight = 600
  ClientWidth = 800
  Caption = 'OYUNLARIM_FORM'
  OnShow = UniFormShow
  BorderStyle = bsNone
  ...
  Script.Strings = (
    ...
    '    if (searchInput.trim() !== "") {'
      ...
      '        ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, "OyunAra", ["k' +
    ...
    '};'
    ''
    'window.openAddGameModal = function(e, targetList) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addGameModal'#39');'
    '    var input = document.getElementById('#39'gameSearchInput'#39');'
    ...
    '};'
    ''
    'window.closeAddGameModal = function(e) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addGameModal'#39');'
    ...
    '};'
    ''
    'window.openGameDetail = function(element, gameId) {'
    '    var posterSrc = element.getAttribute('#39'data-poster'#39') || '#39#39'; '
    
      '    var gameName = element.querySelector('#39'.card-game-title'#39').inn' +
      'erText;'
    '    var gameScore = element.getAttribute('#39'data-score'#39') || '#39'--'#39';'
    '    var gameYear = element.getAttribute('#39'data-year'#39') || '#39'--'#39';'
    '    var gameGenre = element.getAttribute('#39'data-genre'#39') || '#39'--'#39';'
    
      '    var gamePlatform = element.getAttribute('#39'data-platform'#39') || ' +
      #39'--'#39';'
    
      '    var gameSummary = element.getAttribute('#39'data-summary'#39') || '#39'A' +
      #231#305'klama bulunamad'#305'.'#39';'
    
      '    var gameScreenshots = element.getAttribute('#39'data-screenshots' +
      #39') || '#39#39';'
    '    '
      ...
      #39'; '
    ' '
    '    var gameNotes = element.getAttribute('#39'data-notes'#39') || '#39#39'; '
    '    '
    
      '    document.getElementById('#39'resPoster'#39').style.backgroundImage =' +
      ' "url('#39'" + posterSrc + "'#39')";'
    '    document.getElementById('#39'resTitle'#39').innerText = gameName;'
    
      '    document.getElementById('#39'resScore'#39').innerText = gameScore;  ' +
      '  '
    '    document.getElementById('#39'resYear'#39').innerText = gameYear;'
    '    document.getElementById('#39'resGenre'#39').innerText = gameGenre;'
    
      '    document.getElementById('#39'resPlatform'#39').innerText = gamePlatf' +
      'orm;'
    
      '    document.getElementById('#39'resSummary'#39').innerText = gameSummar' +
      'y;'
    '    '
    '    document.getElementById('#39'resNotesText'#39').value = gameNotes;'
    '    '
    '    var scoreSpan = document.getElementById('#39'resScore'#39');'
    '    var scoreTagDiv = scoreSpan.parentElement;'
    '    '
    '    var scoreStr = gameScore.split('#39'/'#39')[0].replace('#39','#39', '#39'.'#39');'
    ...
    '    }'
    '    '
    '    var galleryBox = document.getElementById('#39'resGallery'#39');'
    '    galleryBox.innerHTML = '#39#39'; '
    
      '    if (window.galleryInterval) clearInterval(window.galleryInte' +
      'rval);'
    '    '
    '    if (gameScreenshots !== '#39#39') {'
    '        var images = gameScreenshots.split('#39','#39');'
    '        var validImages = [];'
    '        for (var i = 0; i < images.length; i++) {'
    
      '            if (images[i].trim() !== '#39#39') validImages.push(images' +
      '[i].trim());'
    '        }'
    '        for (var j = 0; j < validImages.length; j++) {'
    
      '            var highRes = validImages[j].replace('#39't_screenshot_m' +
      'ed'#39', '#39't_1080p'#39');'
    
      '            galleryBox.innerHTML += '#39'<a href="'#39' + highRes + '#39'" t' +
      'arget="_blank" class="gallery-link"><img src="'#39' + validImages[j]' +
      ' + '#39'" class="gallery-img"></a>'#39';'
    '        }'
    '        if (validImages.length > 3) {'
    '            var currentScroll = 0;'
    '            window.galleryInterval = setInterval(function() {'
    
      '                var gModal = document.getElementById('#39'gameDetail' +
      'Modal'#39');'
    
      '                if (!gModal || !gModal.classList.contains('#39'show'#39 +
      ')) {'
    '                    clearInterval(window.galleryInterval); '
    '                    return;'
    '                }'
    
      '                var maxScroll = galleryBox.scrollWidth - gallery' +
      'Box.clientWidth;'
    
      '                var step = (galleryBox.clientWidth - 20) / 3 + 1' +
      '0; '
    '                currentScroll += step;'
    
      '                if (currentScroll > maxScroll + 5) currentScroll' +
      ' = 0;'
    
      '                galleryBox.scrollTo({ left: currentScroll, behav' +
      'ior: '#39'smooth'#39' });'
    '            }, 2500);'
    '        }'
    '    } else {'
    
      '        galleryBox.innerHTML = '#39'<span style="color: var(--text-m' +
      'uted); font-size: 0.8rem; padding: 10px 0;">G'#246'rsel bulunamad'#305'.</' +
      'span>'#39';'
    '    }'
    ''
    ...
    '                if (result.isConfirmed && result.value) {'
      ...
      '                    ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, '#39'O' +
      'yunTarihGuncelleDB'#39', ['#39'oyun_id='#39' + gameId, '#39'tarih='#39' + result.val' +
      'ue]);'
    ...
    '    }'
    ''
    '    // --- G'#220'NCELLENEN KISIM: BUTON Y'#214'NET'#304'M'#304' ---'
    '    var actionBtn = document.getElementById('#39'btnActionGame'#39');'
    '    var revertBtn = document.getElementById('#39'btnRevertGame'#39');'
    ''
    '    if (isWishlist === '#39'1'#39') {'
    
      '        // '#304'STEK L'#304'STES'#304'NDE '#304'SE: "TAMAMLA" G'#214'STER, "GER'#304' AL" G'#304'Z' +
      'LE'
    ...
    '        '
      ...
      ' TAMAMLANDI OLARAK '#304#350'ARETLE'#39';'
    '        actionBtn.className = '#39'action-btn-detail btn-mode-blue'#39';'
    '        actionBtn.onclick = function() {'
    '            // yeni_durum=0 -> Tamamland'#305
    
      '            ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, '#39'OyunGunce' +
      'lleDB'#39', ['#39'oyun_id='#39' + gameId, '#39'yeni_durum=0'#39']);'
    '            window.closeGameDetail();'
    '        };'
    '    } else {'
    '        // TAMAMLANMI'#350'SA: "TAMAMLA" G'#304'ZLE, "GER'#304' AL" G'#214'STER'
    '        actionBtn.style.display = '#39'none'#39';'
    '        revertBtn.style.display = '#39'flex'#39';'
    '        '
    '        // Geri alma i'#351'lemi ('#304'stek listesine d'#246'n)'
    '        revertBtn.onclick = function() {'
    '            // yeni_durum=1 -> '#304'stek Listesi'
    
      '            ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, '#39'OyunGunce' +
      'lleDB'#39', ['#39'oyun_id='#39' + gameId, '#39'yeni_durum=1'#39']);'
    '            window.closeGameDetail();'
    '        };'
    '    }'
    '    // ----------------------------------------'
    ''
    '    var btnDelete = document.getElementById('#39'btnDeleteGame'#39');'
    '    btnDelete.onclick = function() {'
    
      '        var swalHTML = '#39'<span style="color:var(--neon-pink); fon' +
      't-weight:bold;">'#39' + gameName + '#39'</span><br><br>k'#252't'#252'phanenizden k' +
      'al'#305'c'#305' olarak kald'#305'r'#305'lacakt'#305'r.<br>Onayl'#305'yor musunuz?'#39';'
    '        Swal.fire({'
    ...
    '            didOpen: function() {'
      ...
      'ncBtn.style.fontFamily = '#39'"Press Start 2P", cursive'#39'; confBtn.st' +
      'yle.fontSize = '#39'0.7rem'#39'; cancBtn.style.cursor = '#39'pointer'#39';'
    '            }'
    '        }).then(function(result) {'
    '            if (result.isConfirmed) {'
    
      '                ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, '#39'OyunS' +
      'ilDB'#39', ['#39'oyun_id='#39' + gameId]);'
    '                window.closeGameDetail();'
    '            }'
    '        });'
    '    };'
    ...
    '        '
      ...
      '        ajaxRequest(OYUNLARIM_FORM.UniHTMLFrame1, '#39'OyunNotKaydet' +
      'DB'#39', ['#39'oyun_id='#39' + gameId, '#39'not='#39' + newNote]);'
    '        '
    ...
    '    };'
    '    '
    '    var modal = document.getElementById('#39'gameDetailModal'#39');'
  ...
  object UniHTMLFrame1: TUniHTMLFrame
    ...
    HTML.Strings = (
      ...
      '  '
      '  .meta-tag.score {'
      #9'background: rgba(5, 217, 232, 0.05);'
      #9'border: 1px solid var(--neon-pink);'
      #9'color: var(--neon-blue);'
      #9'padding: 8px 12px;'
      #9'border-radius: 4px;'
      #9'font-size: 0.7rem;'
      #9'font-family: '#39'Press Start 2P'#39', cursive;'
      #9'display: flex;'
      ...
      ''
        ...
        '  .gallery-link { width: calc((100% - 20px) / 3); height: 90px; ' +
        'flex-shrink: 0; display: block; }'
      
        '  .gallery-img { width: 100%; height: 100%; object-fit: cover; b' +
        'order-radius: 4px; border: 1px solid var(--border-color); cursor' +
        ': pointer; transition: 0.3s; }'
      
        '  .gallery-img:hover { border-color: var(--neon-pink); transform' +
        ': scale(1.05); }'
      ''
      ...
      '  .notes-textarea::-webkit-scrollbar { width: 4px; }'
        ...
        'eon-pink); border-radius: 10px; }'
      ''
      '  /* --- MODAL '#220'ST BUTONLARI ('#199#246'p Kutusu ve Kapat) --- */'
      '  .modal-header-btn {'
      '      background: none;'
      '      border: none;'
      '      color: var(--text-muted); /* Rengi de'#287'i'#351'kene ba'#287'lad'#305'k! */'
      '      cursor: pointer;'
      '      transition: 0.3s;'
      '      padding: 0;'
      '  }'
      '  /* Hover durumlar'#305' i'#231'in '#246'zel renkler */'
      
        '  #btnDeleteGame:hover { color: #ff003c !important; } /* Silme k' +
        #305'rm'#305'z'#305' kals'#305'n */'
      ...
      '      cursor: pointer;'
        ...
        '      color: var(--text-main); /* Tema metin rengine uyum sa'#287'lar' +
        ' */'
      '      transition: color 0.3s ease;'
      '  }'
      '  #btnEditFinishDate:hover {'
      
        '      color: var(--neon-blue); /* '#220'zerine gelince neon mavi parl' +
        'ar */'
      '  }'
      ''
      ''
      ...
      '    <nav class="nav-group">'
        ...
        '      <div class="nav-item" onclick="ajaxRequest(OYUNLARIM_FORM.' +
        'UniHTMLFrame1, '#39'homePageCall'#39', [])"><i class="fa-solid fa-house"' +
        '></i> Ana Sayfa</div>'
      
        '      <div class="nav-item active" onclick="ajaxRequest(OYUNLARI' +
        'M_FORM.UniHTMLFrame1, '#39'gamesPageCall'#39', [])"><i class="fa-solid f' +
        'a-gamepad"></i> Oyunlar'#305'm</div>'
      ...
      '    <div class="made-with-love">'
        ...
        '      Made with <span class="heart"><i class="fa-solid fa-heart"' +
        ' style="color: rgb(255, 0, 0);"></i></span><br>'
      
        '      by <span class="author"><a href="https://hasup.net" target' +
        '="_blank">Yu'#351'a G'#246'verdik</a></span>'
      '      </div>'
      ...
      '      </div>'
        ...
        '    <div class="nav-item logout-btn" onclick="ajaxRequest(OYUNLA' +
        'RIM_FORM.UniHTMLFrame1, '#39'DoLogout'#39', [])"><i class="fa-solid fa-r' +
        'ight-from-bracket"></i> '#199#305'k'#305#351' Yap</div>'
      '  </aside>'
      ''
      ...
      '    <section class="full-section" id="wishlistSection">'
        ...
        'a-heart"></i> '#304'STEK L'#304'STES'#304'_</div>'
      ...
      '    <section class="full-section" id="completedSection">'
        ...
        'a-check-double"></i> TAMAMLANANLAR_</div>'
      ...
      '        <input type="hidden" id="searchTargetInput" value="0">'
        ...
        '        <input type="text" id="gameSearchInput" class="neon-inpu' +
        't" placeholder="Cyberpunk 2077, RDR2..." onkeypress="if(event.ke' +
        'y === '#39'Enter'#39') window.triggerSearch();">'
      ...
      '  </div>'
      ''
      '  <div class="random-modal-overlay" id="gameDetailModal">'
      ...
      '            <h2 id="resTitle" class="result-title">BA'#350'LIK</h2>'
      '          </div>'
      '          '
      ...
      '        <div class="result-meta">'
        ...
        '          <div class="meta-tag score" id="gameScoreTag"><i class' +
        '="fa-solid fa-star"></i> <span id="resScore">--</span></div>'
        ...
        '          <div class="meta-tag"><i class="fa-solid fa-gamepad"><' +
        '/i> <span id="resPlatform">--</span></div>'
      '          '
      ...
      ''
        ...
        '        <div style="font-family: '#39'Press Start 2P'#39', cursive; font' +
        '-size: 0.65rem; color: var(--neon-blue); margin-bottom: 10px; bo' +
        'rder-bottom: 1px dashed rgba(5, 217, 232, 0.3); padding-bottom: ' +
        '5px; flex-shrink: 0;">EKRAN G'#214'R'#220'NT'#220'LER'#304'_</div>'
      
        '        <div id="resGallery" style="display: flex; gap: 10px; ov' +
        'erflow: hidden; padding-bottom: 5px; margin-bottom: 15px; scroll' +
        '-behavior: smooth; flex-shrink: 0; height: 95px;"></div>'
      
        '        <button id="btnActionGame" class="action-btn-detail btn-' +
        'mode-blue"><i class="fa-solid fa-check"></i> TAMAMLANDI OLARAK '#304 +
        #350'ARETLE</button>'
      '      '
      
        '        <button id="btnRevertGame" class="action-btn-detail btn-' +
        'mode-pink" style="display:none; margin-top: 10px;">'
      
        '         <i class="fa-solid fa-rotate-left"></i> '#304'STEK L'#304'STES'#304'NE' +
        ' TA'#350'I'
      '         </button> '
      '      '
      '      </div>'
      ...
      '        <div class="notes-title">'
        ...
        '-up" style="color:rgba(255,255,255,0.3); font-size:0.8rem; displ' +
        'ay:none;" title="Kaydedildi"></i>'
      '        </div>'
      
        '        <textarea id="resNotesText" class="notes-textarea" place' +
        'holder="Bu oyun hakk'#305'nda ne d'#252#351#252'n'#252'yorsun? Buraya kendi '#351'ahsi not' +
