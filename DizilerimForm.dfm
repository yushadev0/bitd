object DIZILERIM_FORM: TDIZILERIM_FORM
  Left = 0
  Top = 0
  ClientHeight = 600
  ClientWidth = 800
  Caption = 'DIZILERIM_FORM'
  OnShow = UniFormShow
  BorderStyle = bsNone
  ...
  Script.Strings = (
    'window.triggerSearch = function() {'
      ...
      '    var searchInput = document.getElementById("tvSearchInput").v' +
      'alue;'
    ...
    '    if (searchInput.trim() !== "") {'
      ...
      '        ajaxRequest(DIZILERIM_FORM.UniHTMLFrame1, "DiziAra", ["k' +
    ...
    '};'
    ''
    'window.openAddTvShowModal = function(e, targetList) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addTvShowModal'#39');'
    '    var input = document.getElementById('#39'tvSearchInput'#39');'
    ...
    '};'
    ''
    'window.closeAddTvShowModal = function(e) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addTvShowModal'#39');'
    ...
    '};'
    ''
    'window.openTvShowDetail = function(element, tvId) {'
    '    var posterSrc = element.getAttribute('#39'data-poster'#39') || '#39#39'; '
    
      '    var tvName = element.querySelector('#39'.card-game-title'#39').inner' +
      'Text;'
    '    var tvScore = element.getAttribute('#39'data-score'#39') || '#39'--'#39';'
    '    var tvYear = element.getAttribute('#39'data-year'#39') || '#39'--'#39';'
    '    var tvGenre = element.getAttribute('#39'data-genre'#39') || '#39'--'#39';'
    
      '    var tvSeasons = element.getAttribute('#39'data-seasons'#39') || '#39'--'#39 +
      ';'
    
      '    var tvNetwork = element.getAttribute('#39'data-network'#39') || '#39'--'#39 +
      ';'
    
      '    var tvSummary = element.getAttribute('#39'data-summary'#39') || '#39'A'#231#305 +
      'klama bulunamad'#305'.'#39';'
    '    var tvNotes = element.getAttribute('#39'data-notes'#39') || '#39#39';'
    '    '
    ...
    '    var rawDate = element.getAttribute('#39'data-rawdate'#39') || '#39#39'; '
      ...
      #39'; '
    '    '
    '    // G'#252'venli Element Atamalar'#305
    '    var elPoster = document.getElementById('#39'resPoster'#39');'
    
      '    if(elPoster) elPoster.style.backgroundImage = "url('#39'" + post' +
      'erSrc + "'#39')";'
    '    '
    
      '    if(document.getElementById('#39'resTitle'#39')) document.getElementB' +
      'yId('#39'resTitle'#39').innerText = tvName;'
    
      '    if(document.getElementById('#39'resScore'#39')) document.getElementB' +
      'yId('#39'resScore'#39').innerText = tvScore;'
    
      '    if(document.getElementById('#39'resYear'#39')) document.getElementBy' +
      'Id('#39'resYear'#39').innerText = tvYear;'
    
      '    if(document.getElementById('#39'resGenre'#39')) document.getElementB' +
      'yId('#39'resGenre'#39').innerText = tvGenre;'
    
      '    if(document.getElementById('#39'resSeasons'#39')) document.getElemen' +
      'tById('#39'resSeasons'#39').innerText = tvSeasons;'
    
      '    if(document.getElementById('#39'resNetwork'#39')) document.getElemen' +
      'tById('#39'resNetwork'#39').innerText = tvNetwork;'
    
      '    if(document.getElementById('#39'resSummary'#39')) document.getElemen' +
      'tById('#39'resSummary'#39').innerText = tvSummary;'
    
      '    if(document.getElementById('#39'resNotesText'#39')) document.getElem' +
      'entById('#39'resNotesText'#39').value = tvNotes;'
    '    '
    '    var scoreSpan = document.getElementById('#39'resScore'#39');'
    '    if (scoreSpan) {'
    '        var scoreTagDiv = scoreSpan.parentElement;'
    '        var scoreStr = tvScore.split('#39'/'#39')[0].replace('#39','#39', '#39'.'#39');'
    '        var scoreNum = parseFloat(scoreStr);'
    ''
    '        if (!isNaN(scoreNum)) {'
    '            if (scoreNum <= 10.0) scoreNum = scoreNum * 10;'
    '            var neonColor = '#39#39';'
    '            if (scoreNum < 50) neonColor = '#39'#ff2a6d'#39'; '
    '            else if (scoreNum < 75) neonColor = '#39'#ffea00'#39'; '
    '            else neonColor = '#39'#39ff14'#39'; '
    '            '
    '            scoreTagDiv.style.borderColor = neonColor;'
    
      '            scoreTagDiv.style.boxShadow = '#39'0 0 10px '#39' + neonColo' +
      'r + '#39', inset 0 0 5px '#39' + neonColor;'
    '        } else {'
    '            scoreTagDiv.style.borderColor = '#39'var(--neon-blue)'#39';'
    
      '            scoreTagDiv.style.boxShadow = '#39'0 0 10px var(--neon-b' +
      'lue)'#39';'
    '        }'
    '    }'
    '    '
    ...
    '        if (isWishlist === '#39'1'#39') {'
      ...
      '            var encodedTitle = encodeURIComponent(tvName).replac' +
      'e(/'#39'/g, "%27");'
    '            trailerContainer.style.display = '#39'block'#39';'
    
      '            trailerContainer.innerHTML = '#39'<button class="action-' +
      'btn-detail btn-mode-pink" onclick="window.open(\'#39'https://www.you' +
      'tube.com/results?search_query='#39' + encodedTitle + '#39'+dizi+fragman\' +
      #39', \'#39'_blank\'#39')" style="width: 100%; margin-top: 0 !important;"><' +
      'i class="fa-brands fa-youtube" style="font-size: 1.2rem;"></i> Y' +
      'OUTUBE\'#39'DA FRAGMAN '#304'ZLE</button>'#39';'
    '        } else {'
    ...
    '            finishDateTag.style.display = '#39'flex'#39'; '
      ...
      '            if(document.getElementById('#39'resFinishDate'#39')) documen' +
      't.getElementById('#39'resFinishDate'#39').innerText = finishDate;'
    '            '
    
      '            var btnEdit = document.getElementById('#39'btnEditFinish' +
      'Date'#39');'
    '            if (btnEdit) {'
    '                btnEdit.onclick = function() {'
    
      '                    var currentRawDate = element.getAttribute('#39'd' +
      'ata-rawdate'#39') || '#39#39';'
    
      '                    var inputHTML = '#39'<input type="text" id="swal' +
      '-input-date" class="neon-input" style="width:140px; display:bloc' +
      'k; margin:15px auto 0 auto; color:var(--text-main); background:v' +
      'ar(--input-bg); border:1px solid var(--border-color); padding:10' +
      'px; border-radius:5px; text-align:center; font-family:\'#39'Outfit\'#39 +
      ', sans-serif; font-size:1.1rem; outline:none; cursor:pointer;" p' +
      'laceholder="Tarih Se'#231'in...">'#39';'
    '                    '
    '                    Swal.fire({'
    '                        title: '#39'B'#304'T'#304'RME TAR'#304'H'#304'_'#39','
    '                        html: inputHTML,'
    ...
    '                        didOpen: function() {'
      ...
      '                            document.querySelector('#39'.swal2-conta' +
      'iner'#39').style.zIndex = '#39'9999999'#39';'
    
      '                            var confBtn = Swal.getConfirmButton(' +
      '); var cancBtn = Swal.getCancelButton();'
    
      '                            confBtn.style.border = '#39'2px solid va' +
      'r(--neon-blue)'#39'; confBtn.style.background = '#39'transparent'#39'; confB' +
      'tn.style.color = '#39'var(--neon-blue)'#39'; confBtn.style.padding = '#39'10' +
      'px 20px'#39'; confBtn.style.fontFamily = '#39'"Press Start 2P", cursive'#39 +
      '; confBtn.style.fontSize = '#39'0.7rem'#39'; confBtn.style.marginRight =' +
      ' '#39'15px'#39'; confBtn.style.cursor = '#39'pointer'#39';'
    
      '                            cancBtn.style.border = '#39'2px solid va' +
      'r(--neon-pink)'#39'; cancBtn.style.background = '#39'transparent'#39'; cancB' +
      'tn.style.color = '#39'var(--neon-pink)'#39'; cancBtn.style.padding = '#39'10' +
      'px 20px'#39'; cancBtn.style.fontFamily = '#39'"Press Start 2P", cursive'#39 +
      '; cancBtn.style.fontSize = '#39'0.7rem'#39'; cancBtn.style.cursor = '#39'poi' +
      'nter'#39';'
    ''
    ...
    '                                flatpickr("#swal-input-date", {'
      ...
      '                                    locale: "tr", dateFormat: "Y' +
      '-m-d", altInput: true, altFormat: "d.m.Y",         '
    
      '                                    defaultDate: currentRawDate ' +
      '!== '#39#39' ? currentRawDate : "today", disableMobile: true         '
    '                                });'
    '                            } else {'
    
      '                                document.getElementById('#39'swal-in' +
      'put-date'#39').type = '#39'date'#39';'
    
      '                                document.getElementById('#39'swal-in' +
      'put-date'#39').value = currentRawDate;'
    '                            }'
    '                        },'
    '                        preConfirm: function() {'
    
      '                            var fpInput = document.querySelector' +
      '('#39'.flatpickr-input[type="hidden"]'#39');'
    
      '                            if (fpInput && fpInput.value !== '#39#39')' +
      ' return fpInput.value;'
    
      '                            return document.getElementById('#39'swal' +
      '-input-date'#39').value;'
    '                        }'
    '                    }).then(function(result) {'
      ...
      '                            ajaxRequest(DIZILERIM_FORM.UniHTMLFr' +
      'ame1, '#39'DiziTarihGuncelleDB'#39', ['#39'dizi_id='#39' + tvId, '#39'tarih='#39' + resu' +
      'lt.value]);'
    
      '                            var formattedDate = result.value.spl' +
      'it('#39'-'#39').reverse().join('#39'.'#39');'
    
      '                            document.getElementById('#39'resFinishDa' +
      'te'#39').innerText = formattedDate;'
    
      '                            element.setAttribute('#39'data-rawdate'#39',' +
      ' result.value);'
    
      '                            element.setAttribute('#39'data-finishdat' +
      'e'#39', formattedDate); '
    '                        }'
    '                    });'
    '                };'
    ...
    '    }'
    ''
    '    // --- BUTON Y'#214'NET'#304'M'#304' (G'#220'VENL'#304') ---'
    '    var actionBtn = document.getElementById('#39'btnActionTvShow'#39');'
    
      '    var revertBtn = document.getElementById('#39'btnRevertTvShows'#39');' +
      ' // Diziler i'#231'in '#246'zel ID'
    ''
    '    if (isWishlist === '#39'1'#39') {'
    '        // '#304'STEK L'#304'STES'#304'NDEYSE -> '#304'ZLE BUTONU AKT'#304'F'
    '        if(actionBtn) {'
    '            actionBtn.style.display = '#39'flex'#39';'
    
      '            actionBtn.innerHTML = '#39'<i class="fa-solid fa-check">' +
      '</i> '#304'ZLEND'#304' OLARAK '#304#350'ARETLE'#39';'
    
      '            actionBtn.className = '#39'action-btn-detail btn-mode-bl' +
      'ue'#39';'
    '            actionBtn.onclick = function() {'
    '                // yeni_durum=0 -> '#304'zlenenlere Ta'#351#305
    
      '                ajaxRequest(DIZILERIM_FORM.UniHTMLFrame1, '#39'DiziG' +
      'uncelleDB'#39', ['#39'dizi_id='#39' + tvId, '#39'yeni_durum=0'#39']);'
    '                window.closeTvShowDetail();'
    '            };'
    '        }'
    '        if(revertBtn) revertBtn.style.display = '#39'none'#39';'
    '    } else {'
    '        // '#304'ZLENM'#304#350'SE -> GER'#304' AL BUTONU AKT'#304'F'
    '        if(actionBtn) actionBtn.style.display = '#39'none'#39';'
    '        if(revertBtn) {'
    '            revertBtn.style.display = '#39'flex'#39';'
    '            revertBtn.onclick = function() {'
    '                // yeni_durum=1 -> '#304'stek Listesine Geri Ta'#351#305
    
      '                ajaxRequest(DIZILERIM_FORM.UniHTMLFrame1, '#39'DiziG' +
      'uncelleDB'#39', ['#39'dizi_id='#39' + tvId, '#39'yeni_durum=1'#39']);'
    '                window.closeTvShowDetail();'
    '            };'
    '        }'
    '    }'
    '    // -------------------------------'
    ''
    '    var btnDelete = document.getElementById('#39'btnDeleteTvShow'#39');'
    '    if (btnDelete) {'
    '        btnDelete.onclick = function() {'
    
      '            var swalHTML = '#39'<span style="color:var(--neon-pink);' +
      ' font-weight:bold;">'#39' + tvName + '#39'</span><br><br>k'#252't'#252'phanenizden' +
    ...
    '                if (result.isConfirmed) {'
      ...
      '                    ajaxRequest(DIZILERIM_FORM.UniHTMLFrame1, '#39'D' +
      'iziSilDB'#39', ['#39'dizi_id='#39' + tvId]);'
    '                    window.closeTvShowDetail();'
    '                }'
    '            });'
    '        };'
    ...
    '        btnSaveNotes.onclick = function() {'
      ...
      '            var newNote = document.getElementById('#39'resNotesText'#39 +
      ').value;'
    
      '            ajaxRequest(DIZILERIM_FORM.UniHTMLFrame1, '#39'DiziNotKa' +
      'ydetDB'#39', ['#39'dizi_id='#39' + tvId, '#39'not='#39' + newNote]);'
    ...
    '                icon.style.color = '#39'var(--neon-blue)'#39';'
      ...
      '                setTimeout(function(){ icon.style.color = '#39'var(-' +
      '-text-muted)'#39'; }, 2000);'
    '            }'
    ...
    '    }'
    '       '
    '    var modal = document.getElementById('#39'tvDetailModal'#39');'
    ...
    '};'
    ''
    'window.closeTvShowDetail = function() {'
    '    var box = document.getElementById('#39'resultBox'#39');'
    '    var modal = document.getElementById('#39'tvDetailModal'#39');'
  ...
  object UniHTMLFrame1: TUniHTMLFrame
    ...
    HTML.Strings = (
      ...
      '  #btnDeleteTvShow:hover { color: #ff003c !important; } '
      ...
      '    <nav class="nav-group">'
        ...
        '      <div class="nav-item" onclick="ajaxRequest(DIZILERIM_FORM.' +
        ...
        '      <div class="nav-item active" onclick="ajaxRequest(DIZILERI' +
        'M_FORM.UniHTMLFrame1, '#39'tvShowsPageCall'#39', [])"><i class="fa-solid' +
        ' fa-tv"></i> Dizilerim</div>'
      ...
      '      </div>'
        ...
        '      <div class="nav-item logout-btn" onclick="ajaxRequest(DIZI' +
      ...
      '      <h1>HO'#350' GELD'#304'N'#304'Z, <span id="spanUser">B'#304'NGER_</span></h1>'
      ...
      '    <section class="full-section" id="completedSection">'
        ...
        'a-check-double"></i> '#304'ZLENEN D'#304'Z'#304'LER_</div>'
      ...
      '  </main>'
      ''
      '  <div class="modal-overlay" id="addTvShowModal">'
      '    <div class="modal-content">'
      
        '      <i class="fa-solid fa-xmark close-modal" onclick="window.c' +
        'loseAddTvShowModal(event)"></i>'
      
        '      <div class="section-title" id="searchModalTitle" style="ma' +
        'rgin-bottom: 10px;"><i class="fa-solid fa-magnifying-glass"></i>' +
        ' D'#304'Z'#304' ARA_</div>'
      '      <div class="search-container">'
      '        <input type="hidden" id="searchTargetInput" value="0">'
      
        '        <input type="text" id="tvSearchInput" class="neon-input"' +
        ' placeholder="Breaking Bad, The Office..." onkeypress="if(event.' +
        'key === '#39'Enter'#39') window.triggerSearch();">'
      ...
      '  </div>'
      ''
      '  <div class="random-modal-overlay" id="tvDetailModal">'
      ...
      '        <div class="result-meta">'
        ...
        '          <div class="meta-tag"><i class="fa-solid fa-list-ol"><' +
        '/i> <span id="resSeasons">--</span></div>'
      
        '          <div class="meta-tag"><i class="fa-solid fa-satellite-' +
        'dish"></i> <span id="resNetwork">--</span></div>'
      '          '
      ...
      '        '
        ...
        '          <button id="btnActionTvShow" class="action-btn-detail ' +
        'btn-mode-blue" style="margin-top: 0 !important;"><i class="fa-so' +
        'lid fa-check"></i> '#304'ZLEND'#304' OLARAK '#304#350'ARETLE</button>'
      '          '
      
        '         <button id="btnRevertTvShows" class="action-btn-detail ' +
        'btn-mode-pink" style="display:none; margin-top: 10px;">'
      ...
      '        </div>'
        ...
        'holder="Bu dizi hakk'#305'nda ne d'#252#351#252'n'#252'yorsun? Buraya kendi '#351'ahsi not' +
