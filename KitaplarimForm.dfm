object KITAPLARIM_FORM: TKITAPLARIM_FORM
  Left = 0
  Top = 0
  ClientHeight = 600
  ClientWidth = 800
  Caption = 'KITAPLARIM_FORM'
  OnShow = UniFormShow
  BorderStyle = bsNone
  ...
  Script.Strings = (
    ...
    '    if (searchInput.trim() !== "") {'
      ...
      '        ajaxRequest(KITAPLARIM_FORM.UniHTMLFrame1, "KitapAra", [' +
      '"kelime=" + searchInput, "hedef=" + targetInput]);'
    '    }'
    '};'
    ''
    ...
    '    var overlay = document.getElementById('#39'sidebarOverlay'#39');'
      ...
      '    if (sidebar && overlay) { sidebar.classList.toggle('#39'open'#39'); ' +
      'overlay.classList.toggle('#39'show'#39'); }'
    '};'
    ''
    'window.openAddBookModal = function(e, targetList) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addBookModal'#39');'
    '    var input = document.getElementById('#39'bookSearchInput'#39');'
    ...
    '        if (targetList == 1) {'
      ...
      '></i> OKUNACAK K'#304'TAP ARA_'#39';'
    '            modalTitle.className = '#39'section-title title-pink'#39';'
    '        } else {'
    
      '            modalTitle.innerHTML = '#39'<i class="fa-solid fa-magnif' +
      'ying-glass"></i> OKUNAN K'#304'TAP ARA_'#39';'
    '            modalTitle.className = '#39'section-title title-blue'#39';'
    '        }'
    '    }'
    '    if (input) input.value = '#39#39';'
    
      '    if (document.getElementById('#39'searchResults'#39')) document.getEl' +
      'ementById('#39'searchResults'#39').innerHTML = '#39#39';'
    
      '    if (modal) { modal.classList.add('#39'show'#39'); setTimeout(functio' +
      'n() { if (input) input.focus(); }, 300); }'
    '};'
    ''
    'window.closeAddBookModal = function(e) {'
    '    if (e) e.stopPropagation();'
    '    var modal = document.getElementById('#39'addBookModal'#39');'
    ...
    '    var allItems = document.querySelectorAll('#39'.accordion-item'#39');'
      ...
      '    if (item.classList.contains('#39'active'#39')) { item.classList.remo' +
      've('#39'active'#39'); return; }'
    
      '    allItems.forEach(function(i) { i.classList.remove('#39'active'#39');' +
      ' });'
    '    item.classList.add('#39'active'#39');'
    '};'
    ''
    'window.openBookDetail = function(element, bookId) {'
    '    try {'
    
      '        var posterSrc = element.getAttribute('#39'data-poster'#39') || '#39 +
      #39'; '
    '        var titleEl = element.querySelector('#39'.card-game-title'#39');'
    
      '        var bookTitle = titleEl ? titleEl.innerText : '#39'Kitap Ba'#351 +
      'l'#305#287#305' Yok'#39';'
    
      '        var bookAuthor = element.getAttribute('#39'data-author'#39') || ' +
      #39'--'#39';'
    
      '        var bookYear = element.getAttribute('#39'data-year'#39') || '#39'--'#39 +
      ';'
    
      '        var bookGenre = element.getAttribute('#39'data-genre'#39') || '#39'-' +
      '-'#39';'
    
      '        var bookPages = element.getAttribute('#39'data-pages'#39') || '#39'-' +
      '-'#39';'
    
      '        var bookSummary = element.getAttribute('#39'data-summary'#39') |' +
      '| '#39'A'#231#305'klama bulunamad'#305'.'#39';'
    
      '        var previewLink = element.getAttribute('#39'data-preview'#39') |' +
      '| '#39#39';'
    
      '        var bookNotes = element.getAttribute('#39'data-notes'#39') || '#39#39 +
      ';'
    
      '        var finishDate = element.getAttribute('#39'data-finishdate'#39')' +
      ' || '#39'Belirtilmedi'#39';'
    
      '        var isWishlist = element.getAttribute('#39'data-wishlist'#39') |' +
      '| '#39'0'#39'; '
    '        '
    
      '        var modalScope = document.getElementById('#39'bookDetailModa' +
      'l'#39');'
    '        if (!modalScope) return; '
    ''
    '        var elPoster = modalScope.querySelector('#39'#resPoster'#39');'
    
      '        if(elPoster) elPoster.style.backgroundImage = "url('#39'" + ' +
      'posterSrc + "'#39')";'
    '        '
    
      '        var elTitle = modalScope.querySelector('#39'#resTitle'#39'); if(' +
      'elTitle) elTitle.innerText = bookTitle;'
    
      '        var elAuthor = modalScope.querySelector('#39'#resAuthor'#39'); i' +
      'f(elAuthor) elAuthor.innerText = bookAuthor;'
    
      '        var elYear = modalScope.querySelector('#39'#resYear'#39'); if(el' +
      'Year) elYear.innerText = bookYear;'
    
      '        var elGenre = modalScope.querySelector('#39'#resGenre'#39'); if(' +
      'elGenre) elGenre.innerText = bookGenre;'
    
      '        var elPages = modalScope.querySelector('#39'#resPages'#39'); if(' +
      'elPages) elPages.innerText = bookPages;'
    
      '        var elSummary = modalScope.querySelector('#39'#resSummary'#39');' +
      ' if(elSummary) elSummary.innerText = bookSummary;'
    
      '        var elNotes = modalScope.querySelector('#39'#resNotesText'#39');' +
      ' if(elNotes) elNotes.value = bookNotes;'
    '        '
    
      '        var previewContainer = modalScope.querySelector('#39'#previe' +
      'wContainer'#39');'
    '        if (previewContainer) {'
    '            if (isWishlist === '#39'1'#39' && previewLink !== '#39#39') {'
    '                previewContainer.style.display = '#39'block'#39';'
    
      '                previewContainer.innerHTML = '#39'<button class="act' +
      'ion-btn-detail btn-mode-pink" onclick="window.open(\'#39#39' + preview' +
      'Link.replace(/'#39'/g, "\\'#39'") + '#39'\'#39', \'#39'_blank\'#39')" style="width: 100%' +
      '; margin-top: 0 !important;"><i class="fa-brands fa-google"></i>' +
      ' GOOGLE BOOKS\'#39'TA '#304'NCELE</button>'#39';'
    '            } else { previewContainer.style.display = '#39'none'#39'; }'
    '        }'
    ''
    
      '        var finishDateTag = modalScope.querySelector('#39'#metaFinis' +
      'hDateTag'#39');'
    '        if (finishDateTag) {'
    '            if (isWishlist === '#39'0'#39') {'
    '                finishDateTag.style.display = '#39'flex'#39'; '
    
      '                var elFinishDate = modalScope.querySelector('#39'#re' +
      'sFinishDate'#39');'
    
      '                if(elFinishDate) elFinishDate.innerText = finish' +
      'Date;'
    
      '                var btnEdit = modalScope.querySelector('#39'#btnEdit' +
      'FinishDate'#39');'
    '                if (btnEdit) {'
    '                    btnEdit.onclick = function() {'
    
      '                        var currentRawDate = element.getAttribut' +
      'e('#39'data-rawdate'#39') || '#39#39';'
    
      '                        var inputHTML = '#39'<input type="text" id="' +
      'swal-input-date" class="neon-input" style="width:140px; display:' +
      'block; margin:15px auto 0 auto; color:var(--text-main); backgrou' +
      'nd:var(--input-bg); border:1px solid var(--border-color); paddin' +
      'g:10px; border-radius:5px; text-align:center; font-family:\'#39'Outf' +
      'it\'#39', sans-serif; font-size:1.1rem; outline:none; cursor:pointer' +
      ';" placeholder="Tarih Se'#231'in...">'#39';'
    '                        Swal.fire({'
    
      '                            title: '#39'B'#304'T'#304'RME TAR'#304'H'#304'_'#39', html: inpu' +
      'tHTML, background: '#39'var(--sidebar-bg)'#39', color: '#39'var(--text-main)' +
      #39', '
    
      '                            showCancelButton: true, confirmButto' +
      'nText: '#39'KAYDET'#39', cancelButtonText: '#39#304'PTAL'#39', buttonsStyling: fals' +
      'e,'
    '                            didOpen: function() {'
    
      '                                document.querySelector('#39'.swal2-c' +
      'ontainer'#39').style.zIndex = '#39'9999999'#39';'
    
      '                                var confBtn = Swal.getConfirmBut' +
      'ton(); var cancBtn = Swal.getCancelButton();'
    
      '                                confBtn.style.border = '#39'2px soli' +
      'd var(--neon-blue)'#39'; confBtn.style.background = '#39'transparent'#39'; c' +
      'onfBtn.style.color = '#39'var(--neon-blue)'#39'; confBtn.style.padding =' +
      ' '#39'10px 20px'#39'; confBtn.style.fontFamily = '#39'"Press Start 2P", curs' +
      'ive'#39'; '
    
      '                                cancBtn.style.border = '#39'2px soli' +
      'd var(--neon-pink)'#39'; cancBtn.style.background = '#39'transparent'#39'; c' +
      'ancBtn.style.color = '#39'var(--neon-pink)'#39'; cancBtn.style.padding =' +
      ' '#39'10px 20px'#39'; cancBtn.style.fontFamily = '#39'"Press Start 2P", curs' +
      'ive'#39'; '
    
      '                                if (typeof flatpickr !== '#39'undefi' +
      'ned'#39') {'
    
      '                                    flatpickr("#swal-input-date"' +
      ', { locale: "tr", dateFormat: "Y-m-d", altInput: true, altFormat' +
      ': "d.m.Y", defaultDate: currentRawDate !== '#39#39' ? currentRawDate :' +
      ' "today", disableMobile: true });'
    '                                } else {'
    
      '                                    var inp = document.getElemen' +
      'tById('#39'swal-input-date'#39'); if(inp) { inp.type = '#39'date'#39'; inp.value' +
      ' = currentRawDate; }'
    '                                }'
    '                            },'
    '                            preConfirm: function() {'
    
      '                                var fpInput = document.querySele' +
      'ctor('#39'.flatpickr-input[type="hidden"]'#39');'
    
      '                                if (fpInput && fpInput.value !==' +
      ' '#39#39') return fpInput.value;'
    
      '                                return document.getElementById('#39 +
      'swal-input-date'#39').value;'
    '                            }'
    '                        }).then(function(result) {'
    
      '                            if (result.isConfirmed && result.val' +
      'ue) {'
    
      '                                ajaxRequest(KITAPLARIM_FORM.UniH' +
      'TMLFrame1, '#39'KitapTarihGuncelleDB'#39', ['#39'kitap_id='#39' + bookId, '#39'tarih' +
      '='#39' + result.value]);'
    
      '                                var formattedDate = result.value' +
      '.split('#39'-'#39').reverse().join('#39'.'#39');'
    
      '                                if(elFinishDate) elFinishDate.in' +
      'nerText = formattedDate;'
    
      '                                element.setAttribute('#39'data-rawda' +
      'te'#39', result.value);'
    
      '                                element.setAttribute('#39'data-finis' +
      'hdate'#39', formattedDate); '
    '                            }'
    '                        });'
    '                    };'
    '                }'
    '            } else { finishDateTag.style.display = '#39'none'#39'; }'
    '        }'
    ''
    
      '        var actionBtn = modalScope.querySelector('#39'#btnActionBook' +
      #39');'
    
      '        var revertBtn = modalScope.querySelector('#39'#btnRevertBook' +
      's'#39'); '
    ...
    '                actionBtn.onclick = function() {'
      ...
      '                    ajaxRequest(KITAPLARIM_FORM.UniHTMLFrame1, '#39 +
      'KitapGuncelleDB'#39', ['#39'kitap_id='#39' + bookId, '#39'yeni_durum=0'#39']);'
    '                    window.closeBookDetail();'
    '                };'
    '            }'
    '            if(revertBtn) revertBtn.style.display = '#39'none'#39';'
    '        } else {'
    '            if(actionBtn) actionBtn.style.display = '#39'none'#39';'
    '            if(revertBtn) {'
    '                revertBtn.style.display = '#39'flex'#39';'
    '                revertBtn.onclick = function() {'
    
      '                    ajaxRequest(KITAPLARIM_FORM.UniHTMLFrame1, '#39 +
      'KitapGuncelleDB'#39', ['#39'kitap_id='#39' + bookId, '#39'yeni_durum=1'#39']);'
    '                    window.closeBookDetail();'
    '                };'
    '            }'
    '        }'
    ''
      ...
      '        var btnDelete = modalScope.querySelector('#39'#btnDeleteBook' +
      #39');'
    '        if (btnDelete) {'
    '            btnDelete.onclick = function() {'
    
      '                var swalHTML = '#39'<span style="color:var(--neon-pi' +
      'nk); font-weight:bold;">'#39' + bookTitle + '#39'</span><br><br>k'#252't'#252'phan' +
      'enizden kal'#305'c'#305' olarak kald'#305'r'#305'lacakt'#305'r.<br>Onayl'#305'yor musunuz?'#39';'
    '                Swal.fire({'
    
      '                    title: '#39'S'#304'LME ONAYI_'#39', html: swalHTML, icon:' +
      ' '#39'warning'#39', iconColor: '#39'var(--neon-pink)'#39', '
    
      '                    showCancelButton: true, confirmButtonText: '#39 +
      'EVET, S'#304'L'#39', cancelButtonText: '#39#304'PTAL'#39', '
    
      '                    background: '#39'var(--sidebar-bg)'#39', color: '#39'var' +
      '(--text-main)'#39', buttonsStyling: false,'
    '                    didOpen: function() {'
    
      '                        document.querySelector('#39'.swal2-container' +
      #39').style.zIndex = '#39'9999999'#39';'
    
      '                        var confBtn = Swal.getConfirmButton(); v' +
      'ar cancBtn = Swal.getCancelButton();'
    
      '                        confBtn.style.border = '#39'2px solid var(--' +
      'neon-blue)'#39'; confBtn.style.background = '#39'transparent'#39'; confBtn.s' +
      'tyle.color = '#39'var(--neon-blue)'#39'; confBtn.style.padding = '#39'10px 2' +
      '0px'#39'; confBtn.style.fontFamily = '#39'"Press Start 2P", cursive'#39'; '
    
      '                        cancBtn.style.border = '#39'2px solid var(--' +
      'neon-pink)'#39'; cancBtn.style.background = '#39'transparent'#39'; cancBtn.s' +
      'tyle.color = '#39'var(--neon-pink)'#39'; cancBtn.style.padding = '#39'10px 2' +
      '0px'#39'; cancBtn.style.fontFamily = '#39'"Press Start 2P", cursive'#39'; '
    '                    }'
    '                }).then(function(result) {'
    '                    if (result.isConfirmed) {'
    
      '                        ajaxRequest(KITAPLARIM_FORM.UniHTMLFrame' +
      '1, '#39'KitapSilDB'#39', ['#39'kitap_id='#39' + bookId]);'
    '                        window.closeBookDetail();'
    '                    }'
    '                });'
    '            };'
    ...
    '        '
      ...
      '        var btnSaveNotes = modalScope.querySelector('#39'#btnSaveNot' +
      'es'#39');'
    '        if (btnSaveNotes) {'
    '            btnSaveNotes.onclick = function() {'
    
      '                var elNotesVal = modalScope.querySelector('#39'#resN' +
      'otesText'#39').value;'
    
      '                ajaxRequest(KITAPLARIM_FORM.UniHTMLFrame1, '#39'Kita' +
      'pNotKaydetDB'#39', ['#39'kitap_id='#39' + bookId, '#39'not='#39' + elNotesVal]);'
    
      '                var icon = modalScope.querySelector('#39'#notesStatu' +
      'sIcon'#39');'
    '                if(icon) {'
    
      '                    icon.style.display = '#39'block'#39'; icon.style.col' +
      'or = '#39'var(--neon-blue)'#39';'
    
      '                    setTimeout(function(){ icon.style.color = '#39'v' +
      'ar(--text-muted)'#39'; }, 2000);'
    '                }'
    '                element.setAttribute('#39'data-notes'#39', elNotesVal);'
    '            };'
    '        }'
    '        '
    '        var box = document.getElementById('#39'resultBox'#39');'
    '        if (modalScope && box) {'
    '            modalScope.classList.add('#39'show'#39');'
    
      '            setTimeout(function() { box.classList.add('#39'reveal'#39');' +
      ' }, 50); '
    '        }'
    '    } catch (err) {'
    '        console.error("Detay a'#231#305'l'#305'rken hata olu'#351'tu:", err);'
    '    }'
    '};'
    ''
    'window.closeBookDetail = function() {'
    '    var box = document.getElementById('#39'resultBox'#39');'
    '    var modal = document.getElementById('#39'bookDetailModal'#39');'
    '    if (box) box.classList.remove('#39'reveal'#39');'
    
      '    setTimeout(function() { if (modal) modal.classList.remove('#39's' +
      'how'#39'); }, 400); '
    '};'
    ''
    ...
    '    var currentTheme = localStorage.getItem('#39'bitd-theme'#39');'
      ...
      '    if (currentTheme === '#39'light'#39') { document.body.classList.add(' +
      #39'light-theme'#39'); }'
    '};'
  ...
  object UniHTMLFrame1: TUniHTMLFrame
    ...
    HTML.Strings = (
      ...
      '    /* --- KOYU TEMA (VARSAYILAN) --- */'
        ...
        '    --neon-pink: #ff2a6d; --neon-blue: #05d9e8; --bg-main: #0101' +
        '2b;'
      '    --sidebar-bg: rgba(10, 10, 35, 0.95); --text-main: #ffffff;'
      
        '    --text-muted: rgba(255, 255, 255, 0.5); --card-bg: rgba(5, 5' +
        ', 25, 0.4);'
      
        '    --border-color: rgba(255, 255, 255, 0.08); --modal-overlay-b' +
        'g: rgba(1, 1, 43, 0.85);'
      
        '    --scanline-opacity: 0.15; --gradient-center: rgba(16, 0, 43,' +
        ' 0.5); --input-bg: rgba(5, 5, 25, 0.6);'
      '  }'
      ''
      '  /* --- A'#199'IK TEMA KODLARI --- */'
      '  body.light-theme {'
      
        '    --neon-pink: #d90045; --neon-blue: #007a8c; --bg-main: #f4f7' +
        'f6; '
      
        '    --sidebar-bg: rgba(245, 247, 250, 0.95); --text-main: #1a1a2' +
        'e; '
      
        '    --text-muted: rgba(0, 0, 0, 0.6); --card-bg: rgba(255, 255, ' +
        '255, 0.8);'
      
        '    --border-color: rgba(0, 0, 0, 0.15); --modal-overlay-bg: rgb' +
        'a(240, 245, 250, 0.95);'
      
        '    --scanline-opacity: 0.03; --gradient-center: rgba(255, 255, ' +
        '255, 0.5); --input-bg: rgba(255, 255, 255, 0.9);'
      '  }'
      ''
      '  /* --- S'#304'BERPUNK TAKV'#304'M --- */'
      ...
      '  #btnDeleteBook:hover { color: #ff003c !important; } '
      ...
      '  #btnEditFinishDate:hover { color: var(--neon-blue); }'
        ...
        '  .result-notes-panel { width: 280px; min-width: 280px; flex-shr' +
        'ink: 0; display: flex; flex-direction: column; border-left: 1px ' +
        'dashed rgba(255, 42, 109, 0.3); padding-left: 30px; opacity: 0; ' +
        'transform: translateX(20px); transition: all 0.8s ease 0.5s; }'
        ...
        '  .notes-textarea { flex: 1; background: var(--input-bg); border' +
        ': 1px solid var(--border-color); border-radius: 8px; color: var(' +
        '--text-main); font-family: '#39'Outfit'#39', sans-serif; font-size: 0.9r' +
        'em; padding: 15px; resize: none; outline: none; line-height: 1.5' +
      ...
      '    <nav class="nav-group">'
        ...
        '      <div class="nav-item" onclick="ajaxRequest(KITAPLARIM_FORM' +
        '.UniHTMLFrame1, '#39'homePageCall'#39', [])"><i class="fa-solid fa-house' +
        '"></i> Ana Sayfa</div>'
      
        '      <div class="nav-item" onclick="ajaxRequest(KITAPLARIM_FORM' +
        '.UniHTMLFrame1, '#39'gamesPageCall'#39', [])"><i class="fa-solid fa-game' +
        'pad"></i> Oyunlar'#305'm</div>'
      
        '      <div class="nav-item" onclick="ajaxRequest(KITAPLARIM_FORM' +
        '.UniHTMLFrame1, '#39'moviesPageCall'#39', [])"><i class="fa-solid fa-fil' +
        'm"></i> Filmlerim</div>'
        ...
        '      <div class="nav-item active" onclick="ajaxRequest(KITAPLAR' +
        'IM_FORM.UniHTMLFrame1, '#39'booksPageCall'#39', [])"><i class="fa-solid ' +
        'fa-book"></i> Kitaplar'#305'm</div>'
      '    </nav>'
      ...
      '      </div>'
        ...
        '      <div class="nav-item logout-btn" onclick="ajaxRequest(KITA' +
        'PLARIM_FORM.UniHTMLFrame1, '#39'DoLogout'#39', [])" style="margin-top: 0' +
        ' !important;"><i class="fa-solid fa-right-from-bracket"></i> '#199#305'k' +
        #305#351' Yap</div>'
      '    </div>'
      '  </aside>'
      ''
      ...
      '    <header class="welcome-section">'
        ...
        '      <h1>HO'#350' GELD'#304'N'#304'Z, <span id="spanUser">K'#304'TAPKURDU_</span></' +
        'h1>'
      ...
      '            <div class="loading-container">'
        ...
        '                <i class="fa-solid fa-circle-notch fa-spin loadi' +
        'ng-icon"></i><br>'
      '                Y'#220'KLEN'#304'YOR...'
      '            </div>'
      '        </div>'
      ...
      '    <section class="full-section" id="completedSection">'
        ...
        'a-check-double"></i> OKUNAN K'#304'TAPLAR_</div>'
      ...
      '    <div class="modal-content">'
        ...
        'loseAddBookModal(event)"></i>'
      
        '      <div class="section-title" id="searchModalTitle"><i class=' +
        '"fa-solid fa-magnifying-glass"></i> K'#304'TAP ARA_</div>'
      '      <div class="search-container">'
      '        <input type="hidden" id="searchTargetInput" value="0">'
      
        '        <input type="text" id="bookSearchInput" class="neon-inpu' +
        't" placeholder="Dune, 1984..." onkeypress="if(event.key === '#39'Ent' +
        'er'#39') window.triggerSearch();">'
      ...
      '  </div>'
      ''
      '  <div class="random-modal-overlay" id="bookDetailModal">'
      ...
      '        <div class="result-meta">'
        ...
        '          <div class="meta-tag"><i class="fa-solid fa-pen-nib"><' +
        '/i> <span id="resAuthor">--</span></div>'
      
        '          <div class="meta-tag"><i class="fa-solid fa-calendar-d' +
        'ays"></i> <span id="resYear">--</span></div>'
      
        '          <div class="meta-tag"><i class="fa-solid fa-file-lines' +
        '"></i> <span id="resPages">--</span></div>'
      ...
      '        '
        ...
        '          <div id="previewContainer" style="display: none; width' +
        ': 100%;"></div>'
      
        '          <button id="btnActionBook" class="action-btn-detail bt' +
        'n-mode-blue" style="margin-top: 0 !important;"><i class="fa-soli' +
        'd fa-check"></i> OKUNDU OLARAK '#304#350'ARETLE</button>'
      '          '
      
        '          <button id="btnRevertBooks" class="action-btn-detail b' +
        'tn-mode-pink" style="display:none; margin-top: 10px;">'
      
        '            <i class="fa-solid fa-rotate-left"></i> '#304'STEK L'#304'STES' +
        #304'NE TA'#350'I'
      '          </button>'
      '          '
      '        </div>'
      ...
      '        </div>'
        ...
        'holder="Bu kitap hakk'#305'nda ne d'#252#351#252'n'#252'yorsun? Buraya kendi '#351'ahsi no' +
        'tlar'#305'n'#305' b'#305'rakabilirsin..."></textarea>'
